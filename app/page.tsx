...
const cards: Card[] = [
  ...
  // NEW CARD 1 - RESTAURANT CATEGORY
  {
    name: 'Isabella Rossi',
    title: 'Executive Chef & Owner',
    company: 'Via Roma Trattoria',
    phone: '(925) 555-0404',
    email: 'isabella@viaroma.com',
    website: 'https://viaroma.com',
    category: 'Restaurant',
  },
  // NEW CARD 2 - EDUCATION CATEGORY
  {
    name: 'Dr. Samuel Okonkwo',
    title: 'High School Principal',
    company: 'Oakland Academy',
    phone: '(925) 555-0505',
    email: 's.okonkwo@oaklandacademy.org',
    website: 'https://oaklandacademy.org',
    category: 'Education',
  },
  // NEW CARD 3 - REAL ESTATE CATEGORY
  {
    name: 'Jennifer Walsh',
    title: 'Real Estate Broker',
    company: 'Golden Gate Properties',
    phone: '(925) 555-0606',
    email: 'jennifer@goldengateprops.com',
    website: 'https://goldengateprops.com',
    category: 'Real Estate',
  },
  // NEW CARD 4 - SERVICES CATEGORY
  {
    name: 'Michael Torres',
    title: 'Master Electrician',
    company: 'Torres Electrical Services',
    phone: '(925) 555-0707',
    email: 'mike@torreselectric.com',
    website: 'https://torreselectric.com',
    category: 'Services',
  },
  // NEW CARD 5 - ARTS CATEGORY (adding new category with custom color)
  {
    name: 'Clara van der Berg',
    title: 'Gallery Director',
    company: 'Clara van der Berg',
    phone: '(925) 555-0808',
    email: 'clara@vanderberg.art',
    website: 'https://vanderberg.art',
    category: 'Arts',
  },
];

// Updated categoryColors to include the new 'Arts' category
const categoryColors: Record<string, string> = {
  ...
  Arts: 'bg-pink-100 text-pink-800', // New color for Arts category
};
